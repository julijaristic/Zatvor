...
{
    public partial class SviZatvoreniciForma : Form
    {
        public SviZatvoreniciForma()
        {
            InitializeComponent();
        }

        public int brZaposlenih = 0;

        private void SviZatvoreniciForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
